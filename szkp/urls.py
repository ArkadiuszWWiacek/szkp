...
urlpatterns = [
    ...
    path('sprawy/<int:case_pk>/dokumenty/<int:pk>/edytuj/',
         views.document_form, name='document_edit'),
    path('sprawy/<int:case_pk>/dokumenty/<int:document_pk>/wersja/',
         views.document_version_upload, name='document_version_upload'),
